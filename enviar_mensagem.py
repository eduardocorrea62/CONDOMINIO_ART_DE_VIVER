...
mensagem = "SUPORTE: Prezados Usuários, está sendo ajustando de 75% para 65% as cisternas A e B para diminuir essa quantidade de mensagens enquanto fazemos a investigação dessas oscilações de níveis."
