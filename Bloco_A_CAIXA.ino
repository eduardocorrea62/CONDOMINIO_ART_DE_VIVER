...
//--------------------------------------------------------------------------------------------------------------------------------------------------
const char* firmwareURL = "https://eduardocorrea62.github.io/CONDOMINIO_ART_DE_VIVER/Bloco_A_CAIXA.ino.bin";
...
BLYNK_WRITE(V21) { // Substitua V1 pelo pino virtual configurado no Blynk
  ...
  if (buttonState == 1) {
    ...
    enviarmensagemWiFi("CAIXA BL A: Botão pressionado no Blynk WEB. Atualizando firmware do ESP32...");
